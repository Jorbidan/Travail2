...
void Donnees::setCommandeFait(int cpt,Commande inCommande)
{
	commandesFait[cpt].setCommandeFinal(inCommande.getcommandeFinal());
	commandesFait[cpt].setNomClient(inCommande.getNomClient());
	for (int cptLignesAchat = 0; cptLignesAchat < 5; cptLignesAchat++)
	{
		commandesFait[cpt].setLignesAchat(cptLignesAchat,
			inCommande.getLigneAchat(cptLignesAchat).getQuantite(),
			inCommande.getLigneAchat(cptLignesAchat).getProduit());
	}
}
